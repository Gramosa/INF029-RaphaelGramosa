...
int main()
{
  //printf("Iniciando o teste: Inicializar\n");
  inicializar();
  //printf("Iniciando o teste: Inserir sem nada\n");
  testeInserirSemNada();
  //printf("Iniciando o teste: Criar estrutura\n");
  testeCriarEstrutura();
  //printf("Iniciando o teste: Inserir com estrutura\n");
  testeInserirComEstrutura();
  //printf("Iniciando o teste: Excluir\n");
  testeExcluir();
  ...
  //printf("Iniciando o teste: Lista encadeada\n");
  testeListaEncadeada();
  //printf("Iniciando o teste: Finalizar\n");
  finalizar();
